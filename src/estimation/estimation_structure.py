...
class TrajectoryScoringData(BaseSchema):
    ...
    Attributes:
        ...
        is_greedy: True if this trajectory was generated by greedy decoding.
            Only set when the generation method records this; defaults to False.
    """
    ...
    # Generated token ids (the part after this arm's prefill). Populated lazily
    # from generation.json when available; empty when token-level info isn't
    # accessible (e.g. remote API trajectories without token streams).
